...
class MediaRssTest extends TestCase
{
    ...
    public function testContentTag()
    {
        ...
        $this->assertEquals(2000, $media->getContentFileSize());
        $this->assertEquals(128, $media->getContentBitrate());
        $this->assertEquals(25, $media->getContentFramerate());
        $this->assertEquals(44.1, $media->getContentSamplingrate());
        $this->assertEquals(185, $media->getContentDuration());
        $this->assertEquals(200, $media->getContentHeight());
        $this->assertEquals(300, $media->getContentWidth());
        $this->assertEquals('en', $media->getContentLang());
        $this->assertEquals('video/quicktime', $media->getType());
        $this->assertEquals(MediaContentExpression::Full, $media->getContentExpression());
        $this->assertEquals(MediaContentMedium::Video, $media->getContentMedium());
        $this->assertTrue($media->isDefault());
    }
    ...
    public function testContentTagDefaults()
    {
        ...
        $this->assertEquals('http://www.foo.com/movie.mov', $media->getUrl());
        $this->assertEquals(null, $media->getContentFileSize());
        $this->assertEquals(null, $media->getContentBitrate());
        $this->assertEquals(null, $media->getContentFramerate());
        $this->assertEquals(null, $media->getContentSamplingrate());
        $this->assertEquals(null, $media->getContentDuration());
        $this->assertEquals(null, $media->getContentHeight());
        $this->assertEquals(null, $media->getContentWidth());
        $this->assertEquals(null, $media->getContentLang());
        $this->assertEquals(null, $media->getType());
        $this->assertEquals(null, $media->getContentExpression());
        $this->assertEquals(null, $media->getContentMedium());
        $this->assertTrue($media->isDefault());
    }
    ...
    public function testRatingTag()
    {
        ...
        $this->assertEquals("r (cz 1 lz 1 nz 1 oz 1 vz 1)", $media->getRating());
        $this->assertEquals('urn:icra', $media->getRatingScheme());
    }
    ...
    public function testRatingTagDefaults()
    {
        ...
        $this->assertEquals("adult", $media->getRating());
        $this->assertEquals('urn:simple', $media->getRatingScheme());
    }
    ...
    public function testTitleTagDefaults()
    {
        ...
        $this->assertEquals("The Judy's -- The Moo Song", $media->getTitle());
        $this->assertEquals(null, $media->getTitleType());
    }
    ...
    public function testThumbnailsTag()
    {
        ...
        $this->assertEquals("http://www.foo.com/keyframe.jpg", $media->getThumbnail());
        $this->assertEquals(75, $media->getThumbnailWidth());
        $this->assertEquals(50, $media->getThumbnailHeight());
        $this->assertEquals(new \DateTime("12:05:01.123"), $media->getThumbnailTime());
    }
    ...
    public function testThumbnailsTagDefaults()
    {
        ...
        $this->assertEquals("http://www.foo.com/keyframe.jpg", $media->getThumbnail());
        $this->assertEquals(null, $media->getThumbnailWidth());
        $this->assertEquals(null, $media->getThumbnailHeight());
        $this->assertEquals(null, $media->getThumbnailTime());
    }
    ...
    public function testCategoryTag()
    {
        ...
        $this->assertEquals("Arts/Movies/Titles/A/Ace_Ventura_Series/Ace_Ventura_ -_Pet_Detective", $media->getCategory());
        $this->assertEquals("Ace Ventura - Pet Detective", $media->getCategoryLabel());
        $this->assertEquals("http://dmoz.org", $media->getCategoryScheme());
    }
    ...
    public function testCategoryTagDefaults()
    {
        ...
        $this->assertEquals("foobar", $media->getCategory());
        $this->assertEquals(null, $media->getCategoryLabel());
        $this->assertEquals("http://search.yahoo.com/mrss/category_schema", $media->getCategoryScheme());
    }
    ...
    public function testHashTag()
    {
        ...
        $this->assertEquals("dfdec888b72151965a34b4b59031290a", $media->getHash());
        $this->assertEquals(MediaHashAlgo::SHA1, $media->getHashAlgo());
    }
    ...
    public function testHashTagDefaults()
    {
        ...
        $this->assertEquals("dfdec888b72151965a34b4b59031290a", $media->getHash());
        $this->assertEquals(MediaHashAlgo::MD5, $media->getHashAlgo());
    }
    ...
    public function testPlayerTag()
    {
        ...
        $this->assertEquals('http://www.foo.com/player?id=1111', $media->getPlayerUrl());
        $this->assertEquals(400, $media->getPlayerWidth());
        $this->assertEquals(200, $media->getPlayerHeight());
    }
    ...
    public function testPlayerTagDefaults()
    {
        ...
        $this->assertEquals('http://www.foo.com/player?id=1111', $media->getPlayerUrl());
        $this->assertEquals(null, $media->getPlayerWidth());
        $this->assertEquals(null, $media->getPlayerHeight());
    }
    ...
    public function testCopyrightTag()
    {
        ...
        $this->assertEquals('2005 FooBar Media', $media->getCopyright());
        $this->assertEquals('http://blah.com/additional-info.html', $media->getCopyrightUrl());
    }
    ...
    public function testCopyrightTagDefaults()
    {
        ...
        $this->assertEquals('2005 FooBar Media', $media->getCopyright());
        $this->assertEquals(null, $media->getCopyrightUrl());
    }
    ...
    public function testRestrictionTag()
    {
        ...
        $this->assertEquals("au us", $media->getRestriction());
        $this->assertEquals(MediaRestrictionType::Country, $media->getRestrictionType());
        $this->assertEquals(MediaRestrictionRelationship::Allow, $media->getRestrictionRelationship());
    }
    ...
    public function testRestrictionTagDefaults()
    {
        ...
        $this->assertEquals("all", $media->getRestriction());
        $this->assertEquals(MediaRestrictionRelationship::Allow, $media->getRestrictionRelationship());
        $this->assertEquals(null, $media->getRestrictionType());
    }
    ...
    public function testCommunityTag()
    {
        ...
        $this->assertEquals(3.5, $media->getStarRatingAverage());
        $this->assertEquals(20, $media->getStarRatingCount());
        $this->assertEquals(1, $media->getStarRatingMin());
        $this->assertEquals(10, $media->getStarRatingMax());
        $this->assertEquals(5, $media->getNbViews());
        $this->assertEquals(5, $media->getNbFavorites());
        $this->assertEquals(array('news' => 5, 'abc' => 3), $media->getTags());
    }
    ...
    public function testCommunityTagDefaults()
    {
        ...
        $this->assertEquals(null, $media->getStarRatingAverage());
        $this->assertEquals(null, $media->getStarRatingCount());
        $this->assertEquals(null, $media->getStarRatingMin());
        $this->assertEquals(null, $media->getStarRatingMax());
        $this->assertEquals(null, $media->getNbViews());
        $this->assertEquals(null, $media->getNbFavorites());
        $this->assertEquals(array(), $media->getTags());
    }
    ...
    public function testEmbedTag()
    {
        ...
        $this->assertEquals('http://www.foo.com/player.swf', $media->getEmbedUrl());
        $this->assertEquals(512, $media->getEmbedWidth());
        $this->assertEquals(323, $media->getEmbedHeight());
    ...
    public function testEmbedTagDefaults()
    {
        ...
        $this->assertEquals('http://www.foo.com/player.swf', $media->getEmbedUrl());
        $this->assertEquals(null, $media->getEmbedWidth());
        $this->assertEquals(null, $media->getEmbedHeight());
        $this->assertEquals(array(), $media->getEmbedParams());
    }
    ...
    public function testStatusTag()
    {
        ...
        $this->assertEquals(MediaStatus::Blocked, $media->getStatus());
        $this->assertEquals("http://www.reasonforblocking.com", $media->getStatusReason());
    }
    ...
    public function testStatusTagDefaults()
    {
        ...
        $this->assertEquals(MediaStatus::Active, $media->getStatus());
        $this->assertEquals(null, $media->getStatusReason());
    }
    ...
    public function testLicenseTag()
    {
        ...
        $this->assertEquals("Sample license for a video", $media->getLicense());
        $this->assertEquals("http://www.licensehost.com/license", $media->getLicenseUrl());
        $this->assertEquals("text/html", $media->getLicenseType());
    }
    ...
    public function testPeerLinkTag()
    {
        ...
        $this->assertEquals('http://www.foo.org/sampleFile.torrent', $media->getPeerLink());
        $this->assertEquals('application/x-bittorrent', $media->getPeerLinkType());
    }
